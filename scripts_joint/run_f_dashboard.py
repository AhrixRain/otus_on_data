...
Usage:
    python scripts_joint/run_f_dashboard.py --device cuda
"""
...
<div class="grid">
  ...
  <div class="card"><h2>Selection score</h2><canvas id="selection"></canvas></div>
...
function renderSelection() {
  ...
  drawChart('selection', labels, [
    { name: 'score', values: rows.map(r => r.joint_selection.selection_score) },
