...
MUPSILON = Parameter(name = 'MUPSILON', nature = 'external', type = 'real', value = 9.46030, texname = '\text{MUPSILON}', lhablock = 'MASS', lhacode = [ 553 ])
WUPSILON = Parameter(name = 'WUPSILON', nature = 'external', type = 'real', value = 0.00005402, texname = '\text{WUPSILON}', lhablock = 'DECAY', lhacode = [ 553 ])
gUpsilon = Parameter(name = 'gUpsilon', nature = 'internal', type = 'real', value = '0.01', texname = 'g_{Upsilon}')
MUPSILON2 = Parameter(name = 'MUPSILON2', nature = 'external', type = 'real', value = 10.0234, texname = '\text{MUPSILON2}', lhablock = 'MASS', lhacode = [ 100553 ])
WUPSILON2 = Parameter(name = 'WUPSILON2', nature = 'external', type = 'real', value = 0.00003198, texname = '\text{WUPSILON2}', lhablock = 'DECAY', lhacode = [ 100553 ])
gUpsilon2 = Parameter(name = 'gUpsilon2', nature = 'internal', type = 'real', value = '0.01', texname = 'g_{Upsilon2}')
MUPSILON3 = Parameter(name = 'MUPSILON3', nature = 'external', type = 'real', value = 10.3551, texname = '\text{MUPSILON3}', lhablock = 'MASS', lhacode = [ 200553 ])
WUPSILON3 = Parameter(name = 'WUPSILON3', nature = 'external', type = 'real', value = 0.00002032, texname = '\text{WUPSILON3}', lhablock = 'DECAY', lhacode = [ 200553 ])
gUpsilon3 = Parameter(name = 'gUpsilon3', nature = 'internal', type = 'real', value = '0.01', texname = 'g_{Upsilon3}')
