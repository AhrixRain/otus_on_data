...
GC_UPSILON = Coupling(name = 'GC_UPSILON', value = 'gUpsilon', order = {'QED':1})
GC_UPSILON2 = Coupling(name = 'GC_UPSILON2', value = 'gUpsilon2', order = {'QED':1})
GC_UPSILON3 = Coupling(name = 'GC_UPSILON3', value = 'gUpsilon3', order = {'QED':1})
